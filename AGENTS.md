...
### 6.2. PBI Submission Format

Submissions must use the following template. Generic suggestions will be rejected.

```
# PBI-XXXX: [Descriptive Title]
**Context Reviewed:** [List files]
**Architecture Alignment:** [Which AGENTS.md directives does this satisfy?]
**Quality Gates:**
- [ ] `pnpm lint` passes
- [ ] `pnpm check` passes
- [ ] `pnpm build` succeeds
