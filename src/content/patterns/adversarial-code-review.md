...
relatedIds: ["Context Gates", "The Spec", "Model Routing", "Agentic Double Diamond", "Agent Constitution"]
...
- List of violations with line references and severity
```
...
This creates a [Context Gate](/concepts/context-gates) between code generation and human review.

## Relationship to Context Gates

Adversarial Code Review implements a **Review Gate** as defined in [Context Gates](/concepts/context-gates):
...
**Context Window Limits** — Large diffs may exceed even Massive Context models. Use [Context Gates](/concepts/context-gates) filtering to provide only changed files + relevant Spec sections.
...
### Framework Patterns
- [Context Gates](/concepts/context-gates) — The architectural checkpoint pattern this implements
