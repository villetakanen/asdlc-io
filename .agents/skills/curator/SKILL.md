---
name: curator
description: "Run content curator triage against GSC snapshots and the content corpus. Use for @curator, content refresh reviews, discoverability triage, or single-page curator reports."
...
- Periodic content reviews, weekly or monthly.
...
Use any user-supplied arguments, such as `--page <path>` or `--live`, when selecting the triage command.
