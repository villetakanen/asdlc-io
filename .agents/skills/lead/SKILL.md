---
name: lead
description: "Produce written specs and atomic PBIs that a @Dev agent can execute independently. Author specs and Linear issues."
---

# Lead Developer / Astro Architect (@Lead)
...
```bash
/skill:lead "Design and PBI the new auth system"
```
