# PBI-68: Create `SpecLineItem` Design System Component

## 1. Directive
Design and implement a new `SpecLineItem.astro` component for the Avionics Design System. This component will provide a dense, scannable list view for directory pages, resolving the scaling limitations of the existing `SpecCard` component when displaying long lists of items.

## 2. Scope
- Create `src/components/SpecLineItem.astro`.
